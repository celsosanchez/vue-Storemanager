...
<script>
import PresentialBuy from "./PresentialBuy.vue";
import ShoppingList from "./ShoppingList.vue";
import config from "../../config";
import axios from "axios";
export default {
  components: { PresentialBuy, ShoppingList },
  ...
  watch:{
    storeSelect(val){
      this.$refs.producerBuy.getData(val)
    }
  },
  created() {
    setTimeout(() => {
